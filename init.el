...
;; TODO: MOVE AND GET GITTED

;; Macos zoom in
(evil-leader/set-key "=" 'toggle-frame-maximized)

;; Lambda notes
(setq org-agenda-files '("/Users/fabri/Documents/LearningPath/"))

(calendar-set-date-style 'european)

;; Newline at the end of file
(setq require-final-newline 'visit-file)
...
(defun org-format-headings (indicator spaces-num filter)
  (let (
        (title-depth (org-map-entries (lambda () (cons (org-current-level) (substring-no-properties (org-get-heading t t t t))))))
        )
